            ...
            <div>
                ...
                className='flex gap-6 flex-col'>
                    ...
                    <div className='flex gap-2'>
                        ...
                        isMulti id='contractTypes' options={contractTypes}
                        className='basis-4/5' required
                        name='contractTypes'
                        onChange={handleAsyncSelectChange}
                        value={AdFormData.contractTypes}
                        />
